...
class TrackGraphPage extends StatefulWidget {
  final String musicCover;
  final String musicTitle;
  final String trackId;

  const TrackGraphPage({
    Key? key,
  ...
  @override
  State<TrackGraphPage> createState() => _TrackGraphPageState();
}

class _TrackGraphPageState extends State<TrackGraphPage> {
  ...
  Future getInfoValues() async {
    ...
    trackAnalytics =
        await provider.getTrackAnalyticsInfo(trackId: widget.trackId);
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: CachedNetworkImageProvider(
                                "$kinAssetBaseUrl/${widget.musicCover}",
                              ),
                              fit: BoxFit.fill,
                            ),
                          ),
