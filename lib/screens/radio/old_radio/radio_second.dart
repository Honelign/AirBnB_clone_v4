...
class MyWidget extends StatefulWidget {
  ...
  int index;
  MyWidget(this.index, this.musicProvider, this.podcastProvider,
      this.radioProvider, this.radioStation);
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      widget.radioStation.mhz.toString(),
    ...
    return GestureDetector(
      child: Container(
        ...
        child: Icon(
          Icons.skip_next,
          size: 40,
          color: radioProvider.isLastStation(index + 1) ? kGrey : Colors.white,
        ),
      ),
      onTap: () {
